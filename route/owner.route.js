...
import { signIn,signUp ,viewProperty ,updateProperty,houseRequestFromTenant, addPropertyDetails, owner_change_password,addProperty, owner_view_profile, viewEnquiry,subscription ,expireSubscription, viewPropertyById, removePropertyById, showSubscriptions, removePropertyDetailsById, removeTenantRequest, updateBalance, findAdmin, houseRequestFromTenantWithoutAdmin, findPropertyByFurnishing, requestUpdate,findByCategoryProperty} from "../controller/owner.controller.js";
...
router.post("/findByCategory",findByCategoryProperty)

router.post("/updateRequest",requestUpdate);
